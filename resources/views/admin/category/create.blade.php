                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Categoris Add</h3>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="category_name" name="category_name" class="form-control" placeholder="Enter categoy name">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="category_discount" name="category_discount" class="form-control" placeholder="Enter category discount">
                                    </div>
                                    <div class="form-group">
                                        <label>Category Description</label>
                                        <textarea class="form-control" id="category_description" name="category_description" rows="3" placeholder="Enter ..."></textarea>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="category_url" name="category_url" class="form-control" placeholder="Enter category url">
                                    </div>
                                    <div class="form-group">
